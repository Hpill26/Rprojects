...
#save graph in pdf
#pdf(file="C:/Users/jmard/Desktop/RegressionMethodsSpring2020/Lecture 02 28JAN2020/Ex3_74_graph.pdf")
...
confint(mod)  #95% confidence interval on regression coefficeints

new.dat <- data.frame(FACTORS=231)
